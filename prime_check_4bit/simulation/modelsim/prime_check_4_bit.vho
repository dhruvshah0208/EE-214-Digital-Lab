...
SIGNAL \scan_instance|In_Reg|L2\ : std_logic_vector(3 DOWNTO 0);
SIGNAL \scan_instance|In_Reg|L1\ : std_logic_vector(3 DOWNTO 0);
...
-- Equation(s):
-- \scan_instance|In_Reg|L1[2]~1_combout\ = (\TRST~combout\) # ((!\TMS~combout\ & (\scan_instance|current_state.s_idle~regout\ & !\scan_instance|current_state.s_update~regout\)))
...
-- Equation(s):
-- \scan_instance|In_Reg|L1\(3) = DFFEAS((\TDI~combout\ & (((!\TRST~combout\ & \scan_instance|Selector3~0\)))), GLOBAL(\TCLK~combout\), VCC, , \scan_instance|In_Reg|L1[2]~1_combout\, , , , )
...
-- Equation(s):
-- \scan_instance|In_Reg|L1\(2) = DFFEAS(((\scan_instance|In_Reg|L1\(3) & (!\TRST~combout\ & \scan_instance|Selector3~0\))), GLOBAL(\TCLK~combout\), VCC, , \scan_instance|In_Reg|L1[2]~1_combout\, , , , )
...
-- Equation(s):
-- \scan_instance|In_Reg|L1\(1) = DFFEAS(((\scan_instance|In_Reg|L1\(2) & (!\TRST~combout\ & \scan_instance|Selector3~0\))), GLOBAL(\TCLK~combout\), VCC, , \scan_instance|In_Reg|L1[2]~1_combout\, , , , )
...
-- Equation(s):
-- \scan_instance|In_Reg|L1\(0) = DFFEAS((\scan_instance|In_Reg|L1\(1) & (((!\TRST~combout\ & \scan_instance|Selector3~0\)))), GLOBAL(\TCLK~combout\), VCC, , \scan_instance|In_Reg|L1[2]~1_combout\, , , , )
...
-- Equation(s):
-- \scan_instance|Out_Reg|mux1[0]~0_combout\ = (\scan_instance|In_Reg|L2\(2) & (\scan_instance|In_Reg|L2\(0) & ((!\scan_instance|In_Reg|L2\(3)) # (!\scan_instance|In_Reg|L2\(1))))) # (!\scan_instance|In_Reg|L2\(2) & (\scan_instance|In_Reg|L2\(1) & 
-- ((\scan_instance|In_Reg|L2\(0)) # (!\scan_instance|In_Reg|L2\(3)))))
...
-- Equation(s):
-- \scan_instance|Out_Reg|mux1[0]~1_combout\ = (!\TRST~combout\ & ((\scan_instance|Selector3~0\ & (\scan_instance|In_Reg|L1\(0))) # (!\scan_instance|Selector3~0\ & ((\scan_instance|Out_Reg|mux1[0]~0_combout\)))))
